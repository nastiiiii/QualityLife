            ...
            <div className="flex flex-col gap-4 justify-start w-[35%] md:w-full">
              ...
              <div className="flex flex-col md:gap-10 gap-[76px] items-start justify-start mr-[27px] w-[93%] md:w-full">
                <div className="bg-white-A700 border-2 border-blue-A700 border-solid flex flex-col items-start justify-start p-2.5 rounded-[21px] w-full">
                  ...
                  ></Input>
                  <Text
                    className="bg-gray-400 h-[50px] justify-center md:ml-[0] ml-[3px] mt-3.5 pb-[9px] pl-4 sm:pr-5 pr-[35px] pt-3 rounded-md text-black-900 text-xl w-[318px]"
                    size="txtManropeSemiBold20"
                  >
                    14/12/2023
                  </Text>
                  <div className="bg-gray-400 flex flex-col items-start justify-start mb-[180px] md:ml-[0] ml-[3px] mt-3.5 p-[9px] rounded-md w-[97%] md:w-full">
